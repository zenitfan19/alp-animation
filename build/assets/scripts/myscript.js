...
$(document).ready(function () {      
    $(document).on('click', '.erp-container-tabs-item', function () { 
      ...
      if($(this).hasClass('active')) {                   
        ...
        if(tab_index == 2) {
          $(document).find('.erp-container-content-graphics-erp').addClass('slide3').removeClass('slide1').removeClass('slide2').removeClass('slide4').css('display', 'block');;
        ...
        if(tab_index == 3) {
          $(document).find('.erp-container-content-graphics-erp').addClass('slide4').removeClass('slide1').removeClass('slide2').removeClass('slide3').css('display', 'block');;
